#! /usr/bin/env bash
#
#  $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/tools/example_scripts/ref_machine/setenv_OpenAD.sh,v 1.1 2017/05/09 00:56:08 jmc Exp $
#  $Name:  $
