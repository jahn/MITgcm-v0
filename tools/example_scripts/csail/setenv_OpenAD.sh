#! /usr/bin/env bash
#
#  $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/tools/example_scripts/csail/setenv_OpenAD.sh,v 1.1 2014/07/17 23:11:50 jmc Exp $
#  $Name:  $
