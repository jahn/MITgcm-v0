C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/tutorial_global_oce_optim/code_ad/FFIELDS.h,v 1.3 2011/04/15 13:41:12 jmc Exp $
C $Name:  $
CBOP
C     !ROUTINE: FFIELDS.h
C     !INTERFACE:
