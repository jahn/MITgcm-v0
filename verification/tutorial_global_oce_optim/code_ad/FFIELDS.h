C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/tutorial_global_oce_optim/code_ad/FFIELDS.h,v 1.2 2010/08/24 15:15:00 jmc Exp $
C $Name:  $
CBOP
C     !ROUTINE: FFIELDS.h
C     !INTERFACE:
