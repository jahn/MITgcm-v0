C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/vero/code/Attic/CPP_OPTIONS.h,v 1.3 2001/05/14 21:59:44 heimbach Exp $
C
...
#if (defined (INCLUDE_ECCO_PACKAGE) || defined (ALLOW_MIT_ADJOINT_RUN))
