#!/bin/bash 
# $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/offline_exf_seaice/input.dyn_jfnk/gmt_res.sh,v 1.1 2012/12/11 22:51:32 mlosch Exp $
# $Name:  $
