C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/seaice_itd/code/DIAGNOSTICS_SIZE.h,v 1.1 2013/04/02 03:59:02 torge Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      PARAMETER( numlists = 33, numperlist = 50, numLevels=2*Nr )
      PARAMETER( numdiags = 24+12*Nr )
