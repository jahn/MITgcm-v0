C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/seaice_itd/code/DIAGNOSTICS_SIZE.h,v 1.2 2014/06/24 08:00:16 mlosch Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      PARAMETER( numlists = 10, numperlist = 50, numLevels=2*15 )
      PARAMETER( numDiags = 20*15 )
