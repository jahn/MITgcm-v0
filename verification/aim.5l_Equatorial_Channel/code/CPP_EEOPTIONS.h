C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/aim.5l_Equatorial_Channel/code/Attic/CPP_EEOPTIONS.h,v 1.1 2001/03/09 19:35:38 adcroft Exp $
C $Name:  $
C
C     /==========================================================\
C     | CPP_EEOPTIONS.h                                          |
