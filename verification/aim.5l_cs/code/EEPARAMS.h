C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/aim.5l_cs/code/Attic/EEPARAMS.h,v 1.1 2001/06/18 17:40:06 cnh Exp $
C $Name:  $
C
C     /==========================================================\
C     | EEPARAMS.h                                               |
