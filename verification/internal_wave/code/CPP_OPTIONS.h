C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/internal_wave/code/CPP_OPTIONS.h,v 1.2 2001/02/04 14:38:53 cnh Exp $
C $Name:  $
C
