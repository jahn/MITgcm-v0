C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/internal_wave/code/CPP_OPTIONS.h,v 1.4.2.1 2001/04/06 15:18:54 jmc Exp $
C $Name:  $
C
