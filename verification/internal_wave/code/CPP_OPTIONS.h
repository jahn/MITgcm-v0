C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/internal_wave/code/CPP_OPTIONS.h,v 1.7 2003/05/27 13:52:01 adcroft Exp $
C $Name:  $
C
