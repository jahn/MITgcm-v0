C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/internal_wave/code/CPP_OPTIONS.h,v 1.5 2001/05/29 14:02:00 adcroft Exp $
C $Name:  $
C
