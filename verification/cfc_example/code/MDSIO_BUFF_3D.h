C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/verification/cfc_example/code/MDSIO_BUFF_3D.h,v 1.1 2013/01/09 22:26:50 jmc Exp $
C $Name:  $
...
#else
c     PARAMETER ( size3dBuf = 2*Nr )
C     increase buffer size (below) for some pkg/layers output:
