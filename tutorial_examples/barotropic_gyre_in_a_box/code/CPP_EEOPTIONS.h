C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/tutorial_examples/barotropic_gyre_in_a_box/code/Attic/CPP_EEOPTIONS.h,v 1.1.4.1 2002/02/26 16:12:01 adcroft Exp $
C $Name:  $
C
C     /==========================================================\
C     | CPP_EEOPTIONS.h                                          |
