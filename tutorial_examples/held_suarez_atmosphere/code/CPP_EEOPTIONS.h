C $Header: /home/jahn/src/cvs2git/MITgcm/20170915-2/gcmpack-all-patch/MITgcm/tutorial_examples/held_suarez_atmosphere/code/Attic/CPP_EEOPTIONS.h,v 1.1.2.1 2002/01/14 17:01:44 cnh Exp $
C $Name:  $
C
C     /==========================================================\
C     | CPP_EEOPTIONS.h                                          |
